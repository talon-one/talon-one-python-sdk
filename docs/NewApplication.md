...
json = "{}"
# create an instance of NewApplication from a JSON string
new_application_instance = NewApplication.from_json(json)
# print the JSON string representation of the object
print(NewApplication.to_json())

# convert the object into a dict
new_application_dict = new_application_instance.to_dict()
# create an instance of NewApplication from a dict
new_application_from_dict = NewApplication.from_dict(new_application_dict)
```
