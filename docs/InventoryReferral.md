...
**referred_customers** | **List[str]** | An array of referred customers. | 
...
json = "{}"
# create an instance of InventoryReferral from a JSON string
inventory_referral_instance = InventoryReferral.from_json(json)
# print the JSON string representation of the object
print(InventoryReferral.to_json())

# convert the object into a dict
inventory_referral_dict = inventory_referral_instance.to_dict()
# create an instance of InventoryReferral from a dict
inventory_referral_from_dict = InventoryReferral.from_dict(inventory_referral_dict)
```
