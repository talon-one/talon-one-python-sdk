...
json = "{}"
# create an instance of CreateAchievement from a JSON string
create_achievement_instance = CreateAchievement.from_json(json)
# print the JSON string representation of the object
print(CreateAchievement.to_json())

# convert the object into a dict
create_achievement_dict = create_achievement_instance.to_dict()
# create an instance of CreateAchievement from a dict
create_achievement_from_dict = CreateAchievement.from_dict(create_achievement_dict)
```
