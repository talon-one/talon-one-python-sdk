...
audience_customer_instance = AudienceCustomer.from_json(json)
# print the JSON string representation of the object
print(AudienceCustomer.to_json())

# convert the object into a dict
audience_customer_dict = audience_customer_instance.to_dict()
# create an instance of AudienceCustomer from a dict
audience_customer_from_dict = AudienceCustomer.from_dict(audience_customer_dict)
```
