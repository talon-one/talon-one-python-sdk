...
coupon_deletion_filters_instance = CouponDeletionFilters.from_json(json)
# print the JSON string representation of the object
print(CouponDeletionFilters.to_json())

# convert the object into a dict
coupon_deletion_filters_dict = coupon_deletion_filters_instance.to_dict()
# create an instance of CouponDeletionFilters from a dict
coupon_deletion_filters_from_dict = CouponDeletionFilters.from_dict(coupon_deletion_filters_dict)
```
