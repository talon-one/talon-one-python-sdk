...
json = "{}"
# create an instance of EventV2 from a JSON string
event_v2_instance = EventV2.from_json(json)
# print the JSON string representation of the object
print(EventV2.to_json())

# convert the object into a dict
event_v2_dict = event_v2_instance.to_dict()
# create an instance of EventV2 from a dict
event_v2_from_dict = EventV2.from_dict(event_v2_dict)
```
