...
**cart_items** | [**List[CartItem]**](CartItem.md) | The items to add to this session. **Do not exceed 1000 items** and ensure the sum of all cart item&#39;s &#x60;quantity&#x60; **does not exceed 10.000** per request.  | [optional] 
...
new_customer_session_v2_instance = NewCustomerSessionV2.from_json(json)
# print the JSON string representation of the object
print(NewCustomerSessionV2.to_json())

# convert the object into a dict
new_customer_session_v2_dict = new_customer_session_v2_instance.to_dict()
# create an instance of NewCustomerSessionV2 from a dict
new_customer_session_v2_from_dict = NewCustomerSessionV2.from_dict(new_customer_session_v2_dict)
```
