...
json = "{}"
# create an instance of NewCoupons from a JSON string
new_coupons_instance = NewCoupons.from_json(json)
# print the JSON string representation of the object
print(NewCoupons.to_json())

# convert the object into a dict
new_coupons_dict = new_coupons_instance.to_dict()
# create an instance of NewCoupons from a dict
new_coupons_from_dict = NewCoupons.from_dict(new_coupons_dict)
```
