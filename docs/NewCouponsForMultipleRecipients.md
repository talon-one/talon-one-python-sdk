...
json = "{}"
# create an instance of NewCouponsForMultipleRecipients from a JSON string
new_coupons_for_multiple_recipients_instance = NewCouponsForMultipleRecipients.from_json(json)
# print the JSON string representation of the object
print(NewCouponsForMultipleRecipients.to_json())

# convert the object into a dict
new_coupons_for_multiple_recipients_dict = new_coupons_for_multiple_recipients_instance.to_dict()
# create an instance of NewCouponsForMultipleRecipients from a dict
new_coupons_for_multiple_recipients_from_dict = NewCouponsForMultipleRecipients.from_dict(new_coupons_for_multiple_recipients_dict)
```
