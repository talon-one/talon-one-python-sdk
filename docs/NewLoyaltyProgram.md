...
json = "{}"
# create an instance of NewLoyaltyProgram from a JSON string
new_loyalty_program_instance = NewLoyaltyProgram.from_json(json)
# print the JSON string representation of the object
print(NewLoyaltyProgram.to_json())

# convert the object into a dict
new_loyalty_program_dict = new_loyalty_program_instance.to_dict()
# create an instance of NewLoyaltyProgram from a dict
new_loyalty_program_from_dict = NewLoyaltyProgram.from_dict(new_loyalty_program_dict)
```
