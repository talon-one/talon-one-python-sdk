...
json = "{}"
# create an instance of AddLoyaltyPoints from a JSON string
add_loyalty_points_instance = AddLoyaltyPoints.from_json(json)
# print the JSON string representation of the object
print(AddLoyaltyPoints.to_json())

# convert the object into a dict
add_loyalty_points_dict = add_loyalty_points_instance.to_dict()
# create an instance of AddLoyaltyPoints from a dict
add_loyalty_points_from_dict = AddLoyaltyPoints.from_dict(add_loyalty_points_dict)
```
