...
additional_campaign_properties_instance = AdditionalCampaignProperties.from_json(json)
# print the JSON string representation of the object
print(AdditionalCampaignProperties.to_json())

# convert the object into a dict
additional_campaign_properties_dict = additional_campaign_properties_instance.to_dict()
# create an instance of AdditionalCampaignProperties from a dict
additional_campaign_properties_from_dict = AdditionalCampaignProperties.from_dict(additional_campaign_properties_dict)
```
