...
new_attribute_instance = NewAttribute.from_json(json)
# print the JSON string representation of the object
print(NewAttribute.to_json())

# convert the object into a dict
new_attribute_dict = new_attribute_instance.to_dict()
# create an instance of NewAttribute from a dict
new_attribute_from_dict = NewAttribute.from_dict(new_attribute_dict)
```
