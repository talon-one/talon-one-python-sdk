...
**application_name** | **str** | Name of the Application that is connected to the coupon. | 
...
json = "{}"
# create an instance of CouponWithApplication from a JSON string
coupon_with_application_instance = CouponWithApplication.from_json(json)
# print the JSON string representation of the object
print(CouponWithApplication.to_json())

# convert the object into a dict
coupon_with_application_dict = coupon_with_application_instance.to_dict()
# create an instance of CouponWithApplication from a dict
coupon_with_application_from_dict = CouponWithApplication.from_dict(coupon_with_application_dict)
```
