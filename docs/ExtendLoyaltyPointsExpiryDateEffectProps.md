...
json = "{}"
# create an instance of ExtendLoyaltyPointsExpiryDateEffectProps from a JSON string
extend_loyalty_points_expiry_date_effect_props_instance = ExtendLoyaltyPointsExpiryDateEffectProps.from_json(json)
# print the JSON string representation of the object
print(ExtendLoyaltyPointsExpiryDateEffectProps.to_json())

# convert the object into a dict
extend_loyalty_points_expiry_date_effect_props_dict = extend_loyalty_points_expiry_date_effect_props_instance.to_dict()
# create an instance of ExtendLoyaltyPointsExpiryDateEffectProps from a dict
extend_loyalty_points_expiry_date_effect_props_from_dict = ExtendLoyaltyPointsExpiryDateEffectProps.from_dict(extend_loyalty_points_expiry_date_effect_props_dict)
```
