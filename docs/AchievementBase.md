...
json = "{}"
# create an instance of AchievementBase from a JSON string
achievement_base_instance = AchievementBase.from_json(json)
# print the JSON string representation of the object
print(AchievementBase.to_json())

# convert the object into a dict
achievement_base_dict = achievement_base_instance.to_dict()
# create an instance of AchievementBase from a dict
achievement_base_from_dict = AchievementBase.from_dict(achievement_base_dict)
```
