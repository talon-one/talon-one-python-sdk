...
json = "{}"
# create an instance of NewApplicationAPIKey from a JSON string
new_application_api_key_instance = NewApplicationAPIKey.from_json(json)
# print the JSON string representation of the object
print(NewApplicationAPIKey.to_json())

# convert the object into a dict
new_application_api_key_dict = new_application_api_key_instance.to_dict()
# create an instance of NewApplicationAPIKey from a dict
new_application_api_key_from_dict = NewApplicationAPIKey.from_dict(new_application_api_key_dict)
```
