...
achievement_status_entry_instance = AchievementStatusEntry.from_json(json)
# print the JSON string representation of the object
print(AchievementStatusEntry.to_json())

# convert the object into a dict
achievement_status_entry_dict = achievement_status_entry_instance.to_dict()
# create an instance of AchievementStatusEntry from a dict
achievement_status_entry_from_dict = AchievementStatusEntry.from_dict(achievement_status_entry_dict)
```
