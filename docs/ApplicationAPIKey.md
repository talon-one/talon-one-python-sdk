...
json = "{}"
# create an instance of ApplicationAPIKey from a JSON string
application_api_key_instance = ApplicationAPIKey.from_json(json)
# print the JSON string representation of the object
print(ApplicationAPIKey.to_json())

# convert the object into a dict
application_api_key_dict = application_api_key_instance.to_dict()
# create an instance of ApplicationAPIKey from a dict
application_api_key_from_dict = ApplicationAPIKey.from_dict(application_api_key_dict)
```
