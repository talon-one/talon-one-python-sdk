...
extended_coupon_instance = ExtendedCoupon.from_json(json)
# print the JSON string representation of the object
print(ExtendedCoupon.to_json())

# convert the object into a dict
extended_coupon_dict = extended_coupon_instance.to_dict()
# create an instance of ExtendedCoupon from a dict
extended_coupon_from_dict = ExtendedCoupon.from_dict(extended_coupon_dict)
```
