...
update_loyalty_program_instance = UpdateLoyaltyProgram.from_json(json)
# print the JSON string representation of the object
print(UpdateLoyaltyProgram.to_json())

# convert the object into a dict
update_loyalty_program_dict = update_loyalty_program_instance.to_dict()
# create an instance of UpdateLoyaltyProgram from a dict
update_loyalty_program_from_dict = UpdateLoyaltyProgram.from_dict(update_loyalty_program_dict)
```
