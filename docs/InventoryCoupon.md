...
json = "{}"
# create an instance of InventoryCoupon from a JSON string
inventory_coupon_instance = InventoryCoupon.from_json(json)
# print the JSON string representation of the object
print(InventoryCoupon.to_json())

# convert the object into a dict
inventory_coupon_dict = inventory_coupon_instance.to_dict()
# create an instance of InventoryCoupon from a dict
inventory_coupon_from_dict = InventoryCoupon.from_dict(inventory_coupon_dict)
```
