...
json = "{}"
# create an instance of IntegrationCoupon from a JSON string
integration_coupon_instance = IntegrationCoupon.from_json(json)
# print the JSON string representation of the object
print(IntegrationCoupon.to_json())

# convert the object into a dict
integration_coupon_dict = integration_coupon_instance.to_dict()
# create an instance of IntegrationCoupon from a dict
integration_coupon_from_dict = IntegrationCoupon.from_dict(integration_coupon_dict)
```
