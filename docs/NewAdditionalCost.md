...
json = "{}"
# create an instance of NewAdditionalCost from a JSON string
new_additional_cost_instance = NewAdditionalCost.from_json(json)
# print the JSON string representation of the object
print(NewAdditionalCost.to_json())

# convert the object into a dict
new_additional_cost_dict = new_additional_cost_instance.to_dict()
# create an instance of NewAdditionalCost from a dict
new_additional_cost_from_dict = NewAdditionalCost.from_dict(new_additional_cost_dict)
```
