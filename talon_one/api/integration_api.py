...
class IntegrationApi:
    ...
    @validate_call
    def activate_loyalty_points(
        self,
        loyalty_program_id: Annotated[StrictInt, Field(description="The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. ")],
        activate_loyalty_points: Annotated[ActivateLoyaltyPoints, Field(description="body")],
        ...
        :param loyalty_program_id: The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint.  (required)
        :type loyalty_program_id: int
        :param activate_loyalty_points: body (required)
        :type activate_loyalty_points: ActivateLoyaltyPoints
        ...
        _param = self._activate_loyalty_points_serialize(
            loyalty_program_id=loyalty_program_id,
            activate_loyalty_points=activate_loyalty_points,
    ...
    @validate_call
    def activate_loyalty_points_with_http_info(
        self,
        loyalty_program_id: Annotated[StrictInt, Field(description="The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. ")],
        activate_loyalty_points: Annotated[ActivateLoyaltyPoints, Field(description="body")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ActivateLoyaltyPointsResponse]:
        """Activate loyalty points
    ...
    @validate_call
    def activate_loyalty_points_without_preload_content(
        self,
        loyalty_program_id: Annotated[StrictInt, Field(description="The identifier for the loyalty program. You can get the ID with the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. ")],
        activate_loyalty_points: Annotated[ActivateLoyaltyPoints, Field(description="body")],
        _request_timeout: Union[
    ...
    def _activate_loyalty_points_serialize(
        self,
        loyalty_program_id,
        ...
        if activate_loyalty_points is not None:
            _body_params = activate_loyalty_points
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/loyalty_programs/{loyaltyProgramId}/activate_points',
    ...
    def delete_loyalty_transactions_from_ledgers(
        ...
        _param = self._delete_loyalty_transactions_from_ledgers_serialize(
            loyalty_program_id=loyalty_program_id,
            integration_id=integration_id,
            delete_loyalty_transactions_request=delete_loyalty_transactions_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _delete_loyalty_transactions_from_ledgers_serialize(
        self,
        loyalty_program_id,
        integration_id,
        delete_loyalty_transactions_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if delete_loyalty_transactions_request is not None:
            _body_params = delete_loyalty_transactions_request
    ...
    def get_event_v3(
        self,
        integration_id: Annotated[StrictStr, Field(description="The unique ID of the advanced event.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param integration_id: The unique ID of the advanced event. (required)
        :type integration_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_event_v3_serialize(
            integration_id=integration_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_event_v3_with_http_info(
        self,
        integration_id: Annotated[StrictStr, Field(description="The unique ID of the advanced event.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_event_v3_without_preload_content(
        self,
        integration_id: Annotated[StrictStr, Field(description="The unique ID of the advanced event.")],
        _request_timeout: Union[
            None,
    ...
    def _get_event_v3_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/events/{integrationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def track_event_v3(
        self,
        integration_event_v3_request: Annotated[IntegrationEventV3Request, Field(description="body")],
        silent: Annotated[Optional[StrictStr], Field(description="Possible values: `yes` or `no`. - `yes`: Increases the performance of the API call by returning a 204 response. - `no`: Returns a 200 response that contains the updated customer profiles. ")] = None,
        dry: Annotated[Optional[StrictBool], Field(description="Indicates whether to persist the changes. Changes are ignored when `dry=true`. ")] = None,
        force_complete_evaluation: Annotated[Optional[StrictBool], Field(description="Forces evaluation for all matching campaigns regardless of the [campaign evaluation mode](https://docs.talon.one/docs/product/applications/managing-campaign-evaluation#setting-campaign-evaluation-mode). Requires `dry=true`. ")] = None,
        _request_timeout: Union[
        ...
        :param integration_event_v3_request: body (required)
        :type integration_event_v3_request: IntegrationEventV3Request
        :param silent: Possible values: `yes` or `no`. - `yes`: Increases the performance of the API call by returning a 204 response. - `no`: Returns a 200 response that contains the updated customer profiles. 
        :type silent: str
        :param dry: Indicates whether to persist the changes. Changes are ignored when `dry=true`. 
        :type dry: bool
        ...
        _param = self._track_event_v3_serialize(
            integration_event_v3_request=integration_event_v3_request,
            silent=silent,
            dry=dry,
            force_complete_evaluation=force_complete_evaluation,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IntegrationEventV3Response",
            '400': "ErrorResponseWithStatus",
            '401': "ErrorResponseWithStatus",
            '409': "UpdateCustomerSessionV2409Response",
        }
    ...
    @validate_call
    def track_event_v3_with_http_info(
        self,
        integration_event_v3_request: Annotated[IntegrationEventV3Request, Field(description="body")],
        silent: Annotated[Optional[StrictStr], Field(description="Possible values: `yes` or `no`. - `yes`: Increases the performance of the API call by returning a 204 response. - `no`: Returns a 200 response that contains the updated customer profiles. ")] = None,
        dry: Annotated[Optional[StrictBool], Field(description="Indicates whether to persist the changes. Changes are ignored when `dry=true`. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IntegrationEventV3Response]:
        """Track advanced event
    ...
    @validate_call
    def track_event_v3_without_preload_content(
        self,
        integration_event_v3_request: Annotated[IntegrationEventV3Request, Field(description="body")],
        silent: Annotated[Optional[StrictStr], Field(description="Possible values: `yes` or `no`. - `yes`: Increases the performance of the API call by returning a 204 response. - `no`: Returns a 200 response that contains the updated customer profiles. ")] = None,
        dry: Annotated[Optional[StrictBool], Field(description="Indicates whether to persist the changes. Changes are ignored when `dry=true`. ")] = None,
    ...
    def _track_event_v3_serialize(
        self,
        integration_event_v3_request,
        silent,
        dry,
        force_complete_evaluation,
        _request_auth,
        ...
        # process the form parameters
        # process the body parameter
        if integration_event_v3_request is not None:
            _body_params = integration_event_v3_request
    ...
    def unlink_loyalty_card_from_profile(
        self,
        loyalty_program_id: Annotated[StrictInt, Field(description="The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. ")],
        ...
        :type loyalty_program_id: int
        :param loyalty_card_id: The identifier of the loyalty card. You can get this ID using the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint.  **Important**: The loyalty card ID requires [URL encoding](https://www.w3schools.com/tags//ref_urlencode.asp) if it contains special characters. For example, you must encode `NewCard2026%` as `NewCard2026%25`.  (required)
        :type loyalty_card_id: str
        :param loyalty_card_registration: body (required)
        :type loyalty_card_registration: LoyaltyCardRegistration
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._unlink_loyalty_card_from_profile_serialize(
            loyalty_program_id=loyalty_program_id,
            loyalty_card_id=loyalty_card_id,
            loyalty_card_registration=loyalty_card_registration,
            _request_auth=_request_auth,
    ...
    @validate_call
    def unlink_loyalty_card_from_profile_with_http_info(
        self,
        loyalty_program_id: Annotated[StrictInt, Field(description="The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. ")],
        loyalty_card_id: Annotated[str, Field(min_length=4, strict=True, max_length=108, description="The identifier of the loyalty card. You can get this ID using the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint.  **Important**: The loyalty card ID requires [URL encoding](https://www.w3schools.com/tags//ref_urlencode.asp) if it contains special characters. For example, you must encode `NewCard2026%` as `NewCard2026%25`. ")],
        loyalty_card_registration: Annotated[LoyaltyCardRegistration, Field(description="body")],
    ...
    @validate_call
    def unlink_loyalty_card_from_profile_without_preload_content(
        self,
        loyalty_program_id: Annotated[StrictInt, Field(description="The identifier of the card-based loyalty program containing the loyalty card. You can get this ID using the [List loyalty programs](https://docs.talon.one/management-api#tag/Loyalty/operation/getLoyaltyPrograms) endpoint. ")],
        loyalty_card_id: Annotated[str, Field(min_length=4, strict=True, max_length=108, description="The identifier of the loyalty card. You can get this ID using the [List loyalty cards](https://docs.talon.one/management-api#tag/Loyalty-cards/operation/getLoyaltyCards) endpoint.  **Important**: The loyalty card ID requires [URL encoding](https://www.w3schools.com/tags//ref_urlencode.asp) if it contains special characters. For example, you must encode `NewCard2026%` as `NewCard2026%25`. ")],
        loyalty_card_registration: Annotated[LoyaltyCardRegistration, Field(description="body")],
    ...
    def _unlink_loyalty_card_from_profile_serialize(
        self,
        loyalty_program_id,
        loyalty_card_id,
        loyalty_card_registration,
