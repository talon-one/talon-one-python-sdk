...
class CampaignEligibilityExperiment(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="The ID of the experiment.")
    variant_id: StrictInt = Field(description="The ID of the variant assigned to the customer profile.", alias="variantId")
    __properties: ClassVar[List[str]] = ["id", "variantId"]
