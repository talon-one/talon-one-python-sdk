...
class NewRevisionVersion(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "startTime", "endTime", "attributes", "description", "activeRulesetId", "tags", "couponSettings", "referralSettings", "limits", "features"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if active_ruleset_id (nullable) is None
        # and model_fields_set contains the field
        if self.active_ruleset_id is None and "active_ruleset_id" in self.model_fields_set:
            _dict['activeRulesetId'] = None
