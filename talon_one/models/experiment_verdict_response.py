...
class ExperimentVerdictResponse(BaseModel):
    """
    ExperimentVerdictResponse
    """ # noqa: E501
    verdict: ExperimentVerdict
    generated: datetime = Field(description="Timestamp of the moment when the verdict was generated.")
    __properties: ClassVar[List[str]] = ["verdict", "generated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "verdict": ExperimentVerdict.from_dict(obj["verdict"]) if obj.get("verdict") is not None else None,
