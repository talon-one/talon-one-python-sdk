...
class AttributesSettings(BaseModel):
    ...
    """ # noqa: E501
    mandatory: Optional[AttributesMandatory] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of mandatory
        if self.mandatory:
            _dict['mandatory'] = self.mandatory.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mandatory": AttributesMandatory.from_dict(obj["mandatory"]) if obj.get("mandatory") is not None else None
        })
        return _obj
