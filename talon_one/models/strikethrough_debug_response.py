...
class StrikethroughDebugResponse(BaseModel):
    ...
    """ # noqa: E501
    campaigns_ids: Optional[List[StrictInt]] = Field(default=None, description="The campaign IDs that got fetched for the evaluation process.", alias="campaignsIDs")
    effects: Optional[List[StrikethroughEffect]] = Field(default=None, description="The strikethrough effects that are returned from the evaluation process.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "campaignsIDs": obj.get("campaignsIDs"),
