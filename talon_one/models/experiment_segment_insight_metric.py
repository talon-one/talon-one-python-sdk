...
class ExperimentSegmentInsightMetric(BaseModel):
    """
    ...
    def metric_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['avg_session_value', 'avg_discounted_session_value', 'avg_items_per_session']):
            raise ValueError("must be one of enum values ('avg_session_value', 'avg_discounted_session_value', 'avg_items_per_session')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "segments": [ExperimentSegmentInsight.from_dict(_item) for _item in obj["segments"]] if obj.get("segments") is not None else None
        })
        return _obj
