...
class IntegrationStateV2(BaseModel):
    ...
    """ # noqa: E501
    customer_session: Optional[CustomerSessionV2] = Field(default=None, alias="customerSession")
    customer_profile: Optional[CustomerProfile] = Field(default=None, alias="customerProfile")
    event: Optional[Event] = None
    loyalty: Optional[Loyalty] = None
    referral: Optional[InventoryReferral] = None
    coupons: Optional[List[IntegrationCoupon]] = None
    triggered_campaigns: Optional[List[Campaign]] = Field(default=None, alias="triggeredCampaigns")
    ...
    rule_failure_reasons: Optional[List[RuleFailureReason]] = Field(default=None, alias="ruleFailureReasons")
    created_coupons: List[Coupon] = Field(alias="createdCoupons")
    created_referrals: List[Referral] = Field(alias="createdReferrals")
    awarded_giveaways: Optional[List[Giveaway]] = Field(default=None, alias="awardedGiveaways")
    var_return: Optional[ModelReturn] = Field(default=None, alias="return")
    previous_returns: Optional[List[ModelReturn]] = Field(default=None, alias="previousReturns")
    __properties: ClassVar[List[str]] = ["customerSession", "customerProfile", "event", "loyalty", "referral", "coupons", "triggeredCampaigns", "effects", "ruleFailureReasons", "createdCoupons", "createdReferrals", "awardedGiveaways", "return", "previousReturns"]
