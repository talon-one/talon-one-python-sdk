...
class RemoveManyItemsCatalogAction(BaseModel):
    ...
    """ # noqa: E501
    filters: Optional[List[CatalogActionFilter]] = Field(default=None, description="The list of filters used to select the items to patch, joined by `AND`.  **Note:** Every item in the catalog will be removed if there are no filters. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [CatalogActionFilter.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
