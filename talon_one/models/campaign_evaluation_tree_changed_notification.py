...
class CampaignEvaluationTreeChangedNotification(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of old_evaluation_tree
        if self.old_evaluation_tree:
            _dict['oldEvaluationTree'] = self.old_evaluation_tree.to_dict()
        # override the default output from pydantic by calling `to_dict()` of evaluation_tree
        if self.evaluation_tree:
            _dict['evaluationTree'] = self.evaluation_tree.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oldEvaluationTree": CampaignSet.from_dict(obj["oldEvaluationTree"]) if obj.get("oldEvaluationTree") is not None else None,
            "evaluationTree": CampaignSet.from_dict(obj["evaluationTree"]) if obj.get("evaluationTree") is not None else None
        })
        return _obj
