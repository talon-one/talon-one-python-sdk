...
class DeleteCouponsData(BaseModel):
    ...
    batch_id: StrictStr = Field(alias="BatchID")
    ...
    __properties: ClassVar[List[str]] = ["TypeOfChange", "Operation", "EmployeeName", "BatchID", "ApplicationID", "CampaignID", "TotalResultSize", "NotificationType"]

    @field_validator('notification_type')
    def notification_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CouponsDeleted']):
            raise ValueError("must be one of enum values ('CouponsDeleted')")
        return value
