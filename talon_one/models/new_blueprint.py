...
class NewBlueprint(BaseModel):
    ...
    cart_item_filters: Optional[List[CartItemFilterTemplate]] = Field(default=None, description="Array of cart item filters to store in this blueprint. If not provided, will be extracted from the rules. Cart item filters should only contain name (no description, as description is at the blueprint level).", alias="cartItemFilters")
