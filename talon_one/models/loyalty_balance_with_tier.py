...
class LoyaltyBalanceWithTier(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of projected_tier
        if self.projected_tier:
            _dict['projectedTier'] = self.projected_tier.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "projectedTier": ProjectedTier.from_dict(obj["projectedTier"]) if obj.get("projectedTier") is not None else None,
