...
class LoyaltyPointsChangedEventRequest(BaseModel):
    """
    ...
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LoyaltyPointsChanged']):
            raise ValueError("must be one of enum values ('LoyaltyPointsChanged')")
        return value
