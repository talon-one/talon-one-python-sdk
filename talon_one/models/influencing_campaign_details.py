...
class InfluencingCampaignDetails(BaseModel):
    ...
    """ # noqa: E501
    campaign_id: StrictInt = Field(description="Identifier of the campaign that influenced the final price.", alias="campaignId")
    discount_value: Union[StrictFloat, StrictInt] = Field(description="Discount value applied by the campaign.", alias="discountValue")
