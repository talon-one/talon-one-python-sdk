...
class InventoryReferral(BaseModel):
    ...
    referred_customers: List[StrictStr] = Field(description="An array of referred customers.", alias="referredCustomers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "advocateProfileIntegrationId": obj.get("advocateProfileIntegrationId"),
            "friendProfileIntegrationId": obj.get("friendProfileIntegrationId"),
            "attributes": obj.get("attributes"),
            "importId": obj.get("importId"),
            "code": obj.get("code"),
            "usageCounter": obj.get("usageCounter"),
            "batchId": obj.get("batchId"),
            "referredCustomers": obj.get("referredCustomers")
        })
        return _obj
