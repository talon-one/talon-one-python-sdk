...
class SupportRequest(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="Identifier of the support request.")
    ...
    loyalty_program_id: Optional[StrictInt] = Field(default=None, description="Identifier of the loyalty program where the points are added or deducted.", alias="loyaltyProgramId")
    ...
    created_by_user: StrictStr = Field(description="Email address of the customer support agent who created the support request.", alias="createdByUser")
    ...
    processed_at: Optional[datetime] = Field(default=None, description="Timestamp when the request was approved or rejected.", alias="processedAt")
    ...
    processed_by_user: Optional[StrictStr] = Field(default=None, description="Email address of the admin who approved or rejected the support request.", alias="processedByUser")
