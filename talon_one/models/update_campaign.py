...
class UpdateCampaign(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "description", "startTime", "endTime", "attributes", "state", "activeRulesetId", "tags", "features", "couponSettings", "referralSettings", "limits", "campaignGroups", "evaluationGroupId", "type", "linkedStoreIds"]
