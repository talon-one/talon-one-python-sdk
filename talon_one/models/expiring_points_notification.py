...
class ExpiringPointsNotification(BaseModel):
    ...
    data: List[ExpiringPointsData] = Field(description="The array of expiring points.", alias="Data")
    ...
    def notification_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LoyaltyPointsExpiring']):
            raise ValueError("must be one of enum values ('LoyaltyPointsExpiring')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Data": [ExpiringPointsData.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None,
