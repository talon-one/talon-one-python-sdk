...
class LoyaltyProgram(BaseModel):
    ...
    LoyaltyProgram
    """ # noqa: E501
    id: StrictInt = Field(description="The ID of loyalty program.")
    ...
    account_id: StrictInt = Field(description="The ID of the Talon.One account that owns this program.", alias="accountID")
    name: StrictStr = Field(description="The internal name for the Loyalty Program. This is an immutable value.")
    tiers: Optional[List[LoyaltyTier]] = Field(default=None, description="The tiers in this loyalty program.")
