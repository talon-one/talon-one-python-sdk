...
class LoyaltyProgram(BaseModel):
    ...
    LoyaltyProgram
    """ # noqa: E501
    id: StrictInt = Field(description="The ID of loyalty program.", json_schema_extra={"examples": [139]})
    ...
    title: Optional[StrictStr] = Field(default=None, description="The display title for the Loyalty Program.", json_schema_extra={"examples": ["Point collection"]})
    description: Optional[StrictStr] = Field(default=None, description="Description of our Loyalty Program.", json_schema_extra={"examples": ["Customers collect 10 points per 1$ spent"]})
    subscribed_applications: Optional[List[StrictInt]] = Field(default=None, description="A list containing the IDs of all applications that are subscribed to this Loyalty Program.", alias="subscribedApplications", json_schema_extra={"examples": [[132, 97]]})
    default_validity: Optional[StrictStr] = Field(default=None, description="The default duration after which new loyalty points should expire. Can be 'unlimited' or a specific time. The time format is a number followed by one letter indicating the time unit, like '30s', '40m', '1h', '5D', '7W', or 10M'. These rounding suffixes are also supported: - '_D' for rounding down. Can be used as a suffix after 'D', and signifies the start of the day. - '_U' for rounding up. Can be used as a suffix after 'D', 'W', and 'M', and signifies the end of the day, week, and month. ", alias="defaultValidity", json_schema_extra={"examples": ["2W_U"]})
    default_pending: Optional[StrictStr] = Field(default=None, description="The default duration of the pending time after which points should be valid. Accepted values: 'immediate', 'on_action' or a specific time. The time format is a number followed by one letter indicating the time unit, like '30s', '40m', '1h', '5D', '7W', or 10M'. These rounding suffixes are also supported: - '_D' for rounding down. Can be used as a suffix after 'D', and signifies the start of the day. - '_U' for rounding up. Can be used as a suffix after 'D', 'W', and 'M', and signifies the end of the day, week, and month. ", alias="defaultPending", json_schema_extra={"examples": ["immediate"]})
    allow_subledger: Optional[StrictBool] = Field(default=None, description="Indicates if this program supports subledgers inside the program.", alias="allowSubledger", json_schema_extra={"examples": [False]})
    users_per_card_limit: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="The max amount of user profiles with whom a card can be shared. This can be set to 0 for no limit. This property is only used when `cardBased` is `true`. ", alias="usersPerCardLimit", json_schema_extra={"examples": [111]})
    sandbox: Optional[StrictBool] = Field(default=None, description="Indicates if this program is a live or sandbox program. Programs of a given type can only be connected to Applications of the same type.", json_schema_extra={"examples": [True]})
    ...
    account_id: StrictInt = Field(description="The ID of the Talon.One account that owns this program.", alias="accountID", json_schema_extra={"examples": [1]})
    name: StrictStr = Field(description="The internal name for the Loyalty Program. This is an immutable value.", json_schema_extra={"examples": ["my_program"]})
    tiers: Optional[List[LoyaltyTier]] = Field(default=None, description="The tiers in this loyalty program.", json_schema_extra={"examples": [[{"name": "Gold", "minPoints": 300, "id": 3, "created": "2021-06-10T09:05:27.993483Z", "programID": 139}, {"name": "Silver", "minPoints": 200, "id": 2, "created": "2021-06-10T09:04:59.355258Z", "programID": 139}, {"name": "Bronze", "minPoints": 100, "id": 1, "created": "2021-06-10T09:04:39.355258Z", "programID": 139}]]})
    ...
    card_based: StrictBool = Field(description="Defines the type of loyalty program: - `true`: the program is a card-based. - `false`: the program is profile-based. ", alias="cardBased", json_schema_extra={"examples": [True]})
    can_update_tiers: Optional[StrictBool] = Field(default=False, description="`True` if the tier definitions can be updated. ", alias="canUpdateTiers", json_schema_extra={"examples": [True]})
    can_update_tier_expiration_policy: Optional[StrictBool] = Field(default=None, description="`True` if the tier expiration policy can be updated. ", alias="canUpdateTierExpirationPolicy", json_schema_extra={"examples": [True]})
    can_upgrade_to_advanced_tiers: Optional[StrictBool] = Field(default=False, description="`True` if the program can be upgraded to use the `tiersExpireIn` and `tiersDowngradePolicy` properties. ", alias="canUpgradeToAdvancedTiers", json_schema_extra={"examples": [True]})
    can_update_subledgers: Optional[StrictBool] = Field(default=False, description="`True` if the `allowSubledger` property can be updated in the loyalty program. ", alias="canUpdateSubledgers", json_schema_extra={"examples": [True]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "tiers": [LoyaltyTier.from_dict(_item) for _item in obj["tiers"]] if obj.get("tiers") is not None else None,
