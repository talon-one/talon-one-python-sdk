...
class TierDowngradeNotification(BaseModel):
    ...
    data: List[TierDowngradeData] = Field(description="The array of tier downgrade notifications.", alias="Data")
    ...
    def notification_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TierDowngrade']):
            raise ValueError("must be one of enum values ('TierDowngrade')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Data": [TierDowngradeData.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None,
