...
class CustomerSessionV2(BaseModel):
    ...
    total: Union[StrictFloat, StrictInt] = Field(description="The total value of cart items and additional costs in the session, before any discounts are applied.", json_schema_extra={"examples": [134.99]})
    cart_item_total: Union[StrictFloat, StrictInt] = Field(description="The total value of cart items, before any discounts are applied.", alias="cartItemTotal", json_schema_extra={"examples": [99.99]})
