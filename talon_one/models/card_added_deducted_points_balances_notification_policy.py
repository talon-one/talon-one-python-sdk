...
class CardAddedDeductedPointsBalancesNotificationPolicy(BaseModel):
    ...
    def scopes_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
            if i not in set(['all', 'campaign_manager', 'management_api', 'rule_engine']):
                raise ValueError("each list item must be one of ('all', 'campaign_manager', 'management_api', 'rule_engine')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CardAddedDeductedPointsBalancesNotificationPolicy from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CardAddedDeductedPointsBalancesNotificationPolicy from a dict"""
        if obj is None:
            return None
