...
class TierUpgradeData(BaseModel):
    ...
    TierUpgradeData
    """ # noqa: E501
    customer_profile_id: StrictStr = Field(description="The integration ID of the customer profile whose tier was upgraded.", alias="CustomerProfileID", json_schema_extra={"examples": ["URNGV8294NV"]})
    ...
    current_tier: StrictStr = Field(description="The name of the customer's current tier.", alias="CurrentTier", json_schema_extra={"examples": ["Silver"]})
    current_points: Union[StrictFloat, StrictInt] = Field(description="The number of points the customer had at the time of tier upgrade.", alias="CurrentPoints", json_schema_extra={"examples": [120.55]})
    old_tier: Optional[StrictStr] = Field(default=None, description="The name of the customer's previous tier.", alias="OldTier", json_schema_extra={"examples": ["Bronze"]})
    points_required_to_the_next_tier: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of points needed for a customer to reach the next tier.", alias="PointsRequiredToTheNextTier", json_schema_extra={"examples": [23.51]})
