...
class UpdateBlueprint(BaseModel):
    ...
    UpdateBlueprint
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="The display name for the blueprint.")
    description: Optional[StrictStr] = Field(default=None, description="A longer, more detailed description of the blueprint.")
    category: Optional[StrictStr] = Field(default=None, description="Category used to group blueprints.")
    rules: Optional[List[CatalogRule]] = Field(default=None, description="Replaces the stored rules. Rules should only contain title (no description, as description is at the blueprint level).")
    cart_item_filters: Optional[List[CartItemFilterTemplate]] = Field(default=None, description="Replaces the stored cart item filters. Cart item filters should only contain name (no description, as description is at the blueprint level).", alias="cartItemFilters")
