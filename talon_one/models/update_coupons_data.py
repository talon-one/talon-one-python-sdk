...
class UpdateCouponsData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["BatchID", "ApplicationID", "CampaignID", "TypeOfChange", "Operation", "EmployeeName", "NotificationType"]

    @field_validator('notification_type')
    def notification_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CouponsUpdated']):
            raise ValueError("must be one of enum values ('CouponsUpdated')")
        return value
