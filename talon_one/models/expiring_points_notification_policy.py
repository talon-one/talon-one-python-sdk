...
class ExpiringPointsNotificationPolicy(BaseModel):
    ...
    triggers: Annotated[List[ExpiringPointsNotificationTrigger], Field(min_length=1, max_length=3)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "triggers": [ExpiringPointsNotificationTrigger.from_dict(_item) for _item in obj["triggers"]] if obj.get("triggers") is not None else None,
