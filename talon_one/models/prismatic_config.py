...
class PrismaticConfig(BaseModel):
    """
    Config used for accessing integrations in Prismatic
    """ # noqa: E501
    prismatic_url: StrictStr = Field(description="The url used to integrate the Prismatic Marketplace.", alias="prismaticUrl")
    access_token: StrictStr = Field(description="Access token used to authenticate a user in Talon.One.", alias="accessToken")
    __properties: ClassVar[List[str]] = ["prismaticUrl", "accessToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prismaticUrl": obj.get("prismaticUrl"),
