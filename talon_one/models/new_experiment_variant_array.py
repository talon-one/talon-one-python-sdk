...
class NewExperimentVariantArray(BaseModel):
    ...
    """ # noqa: E501
    variants: List[NewExperimentVariant] = Field(description="Array of experiment variants to create")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "variants": [NewExperimentVariant.from_dict(_item) for _item in obj["variants"]] if obj.get("variants") is not None else None
        })
        return _obj
