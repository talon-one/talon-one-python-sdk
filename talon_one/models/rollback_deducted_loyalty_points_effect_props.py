...
class RollbackDeductedLoyaltyPointsEffectProps(BaseModel):
    ...
    value: Union[StrictFloat, StrictInt] = Field(description="The amount of points that were reimbursed.")
    recipient_integration_id: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="The user for whom these points were reimbursed.", alias="recipientIntegrationId", json_schema_extra={"examples": ["URNGV8294NV"]})
    start_date: Optional[datetime] = Field(default=None, description="The date after which the reimbursed points will be valid.", alias="startDate")
    expiry_date: Optional[datetime] = Field(default=None, description="The date after which the reimbursed points will expire.", alias="expiryDate")
