...
class CampaignTemplateParams(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['string', 'number', 'boolean', 'percent', '(list string)', 'time']):
            raise ValueError("must be one of enum values ('string', 'number', 'boolean', 'percent', '(list string)', 'time')")
        return value
