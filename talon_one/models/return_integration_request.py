...
class ReturnIntegrationRequest(BaseModel):
    ...
    def response_content_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['customerSession', 'customerProfile', 'coupons', 'triggeredCampaigns', 'referral', 'loyalty', 'event', 'previousReturns']):
                raise ValueError("each list item must be one of ('customerSession', 'customerProfile', 'coupons', 'triggeredCampaigns', 'referral', 'loyalty', 'event', 'previousReturns')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "return": NewReturn.from_dict(obj["return"]) if obj.get("return") is not None else None,
