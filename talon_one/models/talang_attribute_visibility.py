...
class TalangAttributeVisibility(BaseModel):
    ...
    """ # noqa: E501
    invisible: Optional[List[StrictStr]] = Field(default=None, description="List of attribute names to hide in the UI.")
    visible: Optional[List[StrictStr]] = Field(default=None, description="List of attribute names to show in the UI.")
