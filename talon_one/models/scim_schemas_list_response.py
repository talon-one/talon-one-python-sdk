...
class ScimSchemasListResponse(BaseModel):
    ...
    """ # noqa: E501
    resources: List[ScimSchemaResource] = Field(alias="Resources")
    schemas: Optional[List[StrictStr]] = Field(default=None, description="SCIM schema for the given resource.")
    total_results: Optional[StrictInt] = Field(default=None, description="Number of total results in the response.", alias="totalResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Resources": [ScimSchemaResource.from_dict(_item) for _item in obj["Resources"]] if obj.get("Resources") is not None else None,
