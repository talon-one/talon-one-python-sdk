...
class ApplicationCIFReferences(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicationCartItemFilterId": obj.get("applicationCartItemFilterId"),
            "campaigns": [CampaignDetail.from_dict(_item) for _item in obj["campaigns"]] if obj.get("campaigns") is not None else None
        })
        return _obj
