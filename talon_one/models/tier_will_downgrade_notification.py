...
class TierWillDowngradeNotification(BaseModel):
    ...
    def notification_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TierWillDowngrade']):
            raise ValueError("must be one of enum values ('TierWillDowngrade')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Data": [TierWillDowngradeData.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None,
