...
class APIError(BaseModel):
    ...
    APIError
    """ # noqa: E501
    title: StrictStr = Field(description="Short description of the problem.")
    details: Optional[StrictStr] = Field(default=None, description="Longer description of this specific instance of the problem.")
    source: ErrorSource
