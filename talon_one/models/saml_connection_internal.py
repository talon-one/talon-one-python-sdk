...
class SamlConnectionInternal(BaseModel):
    ...
    metadata_document: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Identity Provider metadata XML document.", alias="metadataDocument")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "metadataDocument": obj.get("metadataDocument")
        })
        return _obj
