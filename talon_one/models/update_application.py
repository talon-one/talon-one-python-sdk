...
class UpdateApplication(BaseModel):
    ...
    default_discount_scope: Optional[StrictStr] = Field(default=None, description="The default scope to apply `setDiscount` effects on if no scope was provided with the effect. ", alias="defaultDiscountScope", json_schema_extra={"examples": ["sessionTotal"]})
    enable_cascading_discounts: Optional[StrictBool] = Field(default=None, description="Indicates if discounts should cascade for this Application.", alias="enableCascadingDiscounts", json_schema_extra={"examples": [True]})
    enable_flattened_cart_items: Optional[StrictBool] = Field(default=None, description="Indicates if cart items of quantity larger than one should be separated into different items of quantity one. ", alias="enableFlattenedCartItems", json_schema_extra={"examples": [True]})
    ...
    default_discount_additional_cost_per_item_scope: Optional[StrictStr] = Field(default=None, description="The default scope to apply `setDiscountPerItem` effects on if no scope was provided with the effect. ", alias="defaultDiscountAdditionalCostPerItemScope", json_schema_extra={"examples": ["price"]})
