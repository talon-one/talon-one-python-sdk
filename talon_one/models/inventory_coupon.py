...
class InventoryCoupon(BaseModel):
    ...
    InventoryCoupon
    """ # noqa: E501
    id: StrictInt = Field(description="The internal ID of the coupon.", json_schema_extra={"examples": [6]})
    created: datetime = Field(description="The time the coupon was created.", json_schema_extra={"examples": ["2020-06-10T09:05:27.993483Z"]})
    ...
    discount_counter: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The amount of discounts given on rules redeeming this coupon. Only usable if a coupon discount budget was set for this coupon.", alias="discountCounter", json_schema_extra={"examples": [10]})
    discount_remainder: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The remaining discount this coupon can give.", alias="discountRemainder", json_schema_extra={"examples": [5]})
    reservation_counter: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The number of times this coupon has been reserved.", alias="reservationCounter", json_schema_extra={"examples": [1]})
    attributes: Optional[Dict[str, Any]] = Field(default=None, description="Custom attributes associated with this coupon.")
    referral_id: Optional[StrictInt] = Field(default=None, description="The integration ID of the referring customer (if any) for whom this coupon was created as an effect.", alias="referralId", json_schema_extra={"examples": [326632952]})
    recipient_integration_id: Optional[Annotated[str, Field(strict=True, max_length=1000)]] = Field(default=None, description="The Integration ID of the customer that is allowed to redeem this coupon.", alias="recipientIntegrationId", json_schema_extra={"examples": ["URNGV8294NV"]})
    import_id: Optional[StrictInt] = Field(default=None, description="The ID of the Import which created this coupon.", alias="importId", json_schema_extra={"examples": [4]})
    reservation: Optional[StrictBool] = Field(default=True, description="Defines the reservation type: - `true`: The coupon can be reserved for multiple customers. - `false`: The coupon can be reserved only for one customer. It is a personal code. ", json_schema_extra={"examples": [False]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profileRedemptionCount": obj.get("profileRedemptionCount"),
            "state": obj.get("state")
        })
        return _obj
