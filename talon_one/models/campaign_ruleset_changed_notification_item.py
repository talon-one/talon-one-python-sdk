...
class CampaignRulesetChangedNotificationItem(BaseModel):
    ...
    old_ruleset: Optional[Ruleset] = Field(default=None, description="The old ruleset, if the ruleset was changed.", alias="oldRuleset")
    old_placeholders: Optional[List[PlaceholderDetails]] = Field(default=None, description="The previous details of the placeholders before the ruleset was changed.", alias="oldPlaceholders")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of old_ruleset
        if self.old_ruleset:
            _dict['oldRuleset'] = self.old_ruleset.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in old_placeholders (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "oldRuleset": Ruleset.from_dict(obj["oldRuleset"]) if obj.get("oldRuleset") is not None else None,
            "oldPlaceholders": [PlaceholderDetails.from_dict(_item) for _item in obj["oldPlaceholders"]] if obj.get("oldPlaceholders") is not None else None,
