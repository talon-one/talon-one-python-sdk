...
class NewLoyaltyProgram(BaseModel):
    ...
    NewLoyaltyProgram
    """ # noqa: E501
    title: StrictStr = Field(description="The display title for the Loyalty Program.", json_schema_extra={"examples": ["Point collection"]})
    ...
    default_validity: StrictStr = Field(description="The default duration after which new loyalty points should expire. Can be 'unlimited' or a specific time. The time format is a number followed by one letter indicating the time unit, like '30s', '40m', '1h', '5D', '7W', or 10M'. These rounding suffixes are also supported: - '_D' for rounding down. Can be used as a suffix after 'D', and signifies the start of the day. - '_U' for rounding up. Can be used as a suffix after 'D', 'W', and 'M', and signifies the end of the day, week, and month. ", alias="defaultValidity", json_schema_extra={"examples": ["2W_U"]})
    default_pending: StrictStr = Field(description="The default duration of the pending time after which points should be valid. Accepted values: 'immediate', 'on_action' or a specific time. The time format is a number followed by one letter indicating the time unit, like '30s', '40m', '1h', '5D', '7W', or 10M'. These rounding suffixes are also supported: - '_D' for rounding down. Can be used as a suffix after 'D', and signifies the start of the day. - '_U' for rounding up. Can be used as a suffix after 'D', 'W', and 'M', and signifies the end of the day, week, and month. ", alias="defaultPending", json_schema_extra={"examples": ["immediate"]})
    allow_subledger: StrictBool = Field(description="Indicates if this program supports subledgers inside the program.", alias="allowSubledger", json_schema_extra={"examples": [False]})
    ...
    name: StrictStr = Field(description="The internal name for the Loyalty Program. This is an immutable value.", json_schema_extra={"examples": ["GeneralPointCollection"]})
    ...
    __properties: ClassVar[List[str]] = ["title", "description", "subscribedApplications", "defaultValidity", "defaultPending", "allowSubledger", "usersPerCardLimit", "sandbox", "programJoinPolicy", "tiersExpirationPolicy", "tierCycleStartDate", "tiersExpireIn", "tiersDowngradePolicy", "cardCodeSettings", "returnPolicy", "name", "tiers", "timezone", "cardBased"]
