...
class NewLoyaltyProgram(BaseModel):
    ...
    NewLoyaltyProgram
    """ # noqa: E501
    title: StrictStr = Field(description="The display title for the Loyalty Program.")
    ...
    allow_subledger: StrictBool = Field(description="Indicates if this program supports subledgers inside the program.", alias="allowSubledger")
    ...
    name: StrictStr = Field(description="The internal name for the Loyalty Program. This is an immutable value.")
