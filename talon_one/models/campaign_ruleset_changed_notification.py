...
class CampaignRulesetChangedNotification(BaseModel):
    ...
    data: Optional[List[CampaignRulesetChangedNotificationItem]] = Field(default=None, description="A list of campaign notification data.", alias="Data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Data": [CampaignRulesetChangedNotificationItem.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None
        })
        return _obj
