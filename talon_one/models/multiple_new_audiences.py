...
class MultipleNewAudiences(BaseModel):
    ...
    """ # noqa: E501
    audiences: List[NewMultipleAudiencesItem]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audiences": [NewMultipleAudiencesItem.from_dict(_item) for _item in obj["audiences"]] if obj.get("audiences") is not None else None
        })
        return _obj
