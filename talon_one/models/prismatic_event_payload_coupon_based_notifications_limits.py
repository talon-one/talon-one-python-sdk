...
class PrismaticEventPayloadCouponBasedNotificationsLimits(BaseModel):
    """
    PrismaticEventPayloadCouponBasedNotificationsLimits
    """ # noqa: E501
    action: StrictStr = Field(alias="Action")
    limit: Union[StrictFloat, StrictInt] = Field(alias="Limit")
    period: Optional[StrictStr] = Field(default=None, alias="Period")
    entities: List[StrictStr] = Field(alias="Entities")
