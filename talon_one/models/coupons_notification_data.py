...
class CouponsNotificationData(BaseModel):
    ...
    def notification_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CouponUpdated', 'CouponDeleted']):
            raise ValueError("must be one of enum values ('CouponUpdated', 'CouponDeleted')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [ExtendedCoupon.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
