...
class AnalyticsDataPointWithTrendAndUplift(BaseModel):
    ...
    uplift: Union[StrictFloat, StrictInt] = Field(json_schema_extra={"examples": [3.25]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalyticsDataPointWithTrendAndUplift from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalyticsDataPointWithTrendAndUplift from a dict"""
        if obj is None:
            return None
