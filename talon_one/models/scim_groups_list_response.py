...
class ScimGroupsListResponse(BaseModel):
    ...
    total_results: Optional[StrictInt] = Field(default=None, description="Number of results in the response.", alias="totalResults")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Resources": [ScimGroup.from_dict(_item) for _item in obj["Resources"]] if obj.get("Resources") is not None else None,
