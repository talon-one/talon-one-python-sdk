...
class AttributesMandatory(BaseModel):
    ...
    """ # noqa: E501
    campaigns: Optional[List[StrictStr]] = Field(default=None, description="List of mandatory attributes for campaigns.")
    coupons: Optional[List[StrictStr]] = Field(default=None, description="List of mandatory attributes for campaigns.")
