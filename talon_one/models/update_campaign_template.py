...
class UpdateCampaignTemplate(BaseModel):
    ...
    applications_ids: List[StrictInt] = Field(description="A list of IDs of the Applications that are subscribed to this campaign template.", alias="applicationsIds", json_schema_extra={"examples": [[1, 2, 3]]})
