...
class CampaignCreatedNotification(BaseModel):
    ...
    data: Optional[List[CampaignCreatedNotificationItem]] = Field(default=None, description="A list of campaign notification data.", alias="Data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Data": [CampaignCreatedNotificationItem.from_dict(_item) for _item in obj["Data"]] if obj.get("Data") is not None else None
        })
        return _obj
