...
class ScimServiceProviderConfigResponseFilter(BaseModel):
    ...
    """ # noqa: E501
    max_results: Optional[StrictInt] = Field(default=None, description="The maximum number of resources that can be returned in a single filtered query response.", alias="maxResults")
    supported: Optional[StrictBool] = Field(default=None, description="Indicates whether the SCIM service provider supports filtering operations.")
