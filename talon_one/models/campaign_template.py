...
class CampaignTemplate(BaseModel):
    ...
    applications_ids: List[StrictInt] = Field(alias="applicationsIds")
    ...
    campaigns_count: Optional[StrictInt] = Field(default=None, description="The number of Campaigns created from this template.", alias="campaignsCount")
    updated: Optional[datetime] = Field(default=None, description="Timestamp of the most recent update to the campaign template or any of its elements.")
