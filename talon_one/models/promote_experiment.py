...
class PromoteExperiment(BaseModel):
    ...
    PromoteExperiment
    """ # noqa: E501
    target_application_id: StrictInt = Field(description="The ID of the Application to copy the experiment. It is displayed in your Talon.One deployment URL. ", alias="targetApplicationId")
    variant_id: StrictInt = Field(description="The ID of the Experiment Variant to build the new campaign. ", alias="variantId")
    disable_experiment: Optional[StrictBool] = Field(default=None, description="Force disable the experiment. ", alias="disableExperiment")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "targetApplicationId": obj.get("targetApplicationId"),
            "variantId": obj.get("variantId"),
            "disableExperiment": obj.get("disableExperiment"),
