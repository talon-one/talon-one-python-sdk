...
class CampaignSearch(BaseModel):
    ...
    CampaignSearch
    """ # noqa: E501
    attributes: Dict[str, Any] = Field(description="Properties to match against a campaign. All provided attributes will be exactly matched against campaign attributes.")
