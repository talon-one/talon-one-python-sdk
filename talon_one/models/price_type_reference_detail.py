...
class PriceTypeReferenceDetail(BaseModel):
    ...
    def referencing_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Campaign', 'ApplicationCartItemFilter', 'Template']):
            raise ValueError("must be one of enum values ('Campaign', 'ApplicationCartItemFilter', 'Template')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "referencingType": obj.get("referencingType"),
            "referencingId": obj.get("referencingId"),
            "referencingName": obj.get("referencingName"),
