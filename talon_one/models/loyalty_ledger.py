...
class LoyaltyLedger(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in sub_ledgers (dict)
        _field_dict = {}
        if self.sub_ledgers:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ledger": LoyaltySubLedger.from_dict(obj["ledger"]) if obj.get("ledger") is not None else None,
            "subLedgers": dict(
                (_k, LoyaltySubLedger.from_dict(_v))
