...
class CardLedgerPointsEntryIntegrationAPI(BaseModel):
    ...
    created: datetime = Field(description="Date and time the loyalty card points were added.")
    program_id: StrictInt = Field(description="ID of the loyalty program.", alias="programId")
    customer_profile_id: Optional[StrictStr] = Field(default=None, description="Integration ID of the customer profile linked to the card.", alias="customerProfileID")
    ...
    __properties: ClassVar[List[str]] = ["id", "transactionUUID", "created", "programId", "customerProfileID", "customerSessionId", "name", "startDate", "expiryDate", "subledgerId", "amount"]
