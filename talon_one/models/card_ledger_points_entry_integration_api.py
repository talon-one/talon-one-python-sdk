...
class CardLedgerPointsEntryIntegrationAPI(BaseModel):
    ...
    created: datetime = Field(description="Date and time the loyalty card points were added.", json_schema_extra={"examples": ["2022-01-02T15:04:05Z07:00"]})
    program_id: StrictInt = Field(description="ID of the loyalty program.", alias="programId", json_schema_extra={"examples": [324]})
    customer_profile_id: Optional[StrictStr] = Field(default=None, description="Integration ID of the customer profile linked to the card.", alias="customerProfileID", json_schema_extra={"examples": ["URNGV8294NV"]})
