...
class RiskDetail(BaseModel):
    ...
    affected_entities: List[RiskAffectedEntityItem] = Field(description="The affected entities with the highest severity ratios, in descending order.", alias="affectedEntities")
    __properties: ClassVar[List[str]] = ["id", "created", "notificationId", "runDate", "groupKey", "applicationId", "status", "criticality", "entity", "activity", "timeFrame", "reportedDate", "affectedEntityCount", "description", "modified", "affectedEntities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in affected_entities (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "affectedEntities": [RiskAffectedEntityItem.from_dict(_item) for _item in obj["affectedEntities"]] if obj.get("affectedEntities") is not None else None
        })
        return _obj
