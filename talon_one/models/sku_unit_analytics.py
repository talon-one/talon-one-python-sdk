...
class SkuUnitAnalytics(BaseModel):
    ...
    SkuUnitAnalytics
    """ # noqa: E501
    data: List[SkuUnitAnalyticsDataPoint]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [SkuUnitAnalyticsDataPoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "totals": ProductUnitAnalyticsTotals.from_dict(obj["totals"]) if obj.get("totals") is not None else None
        })
        return _obj
