...
class CustomerProfileSearchQuery(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[Dict[str, Any]] = Field(default=None, description="Properties to match against a customer profile. All provided attributes will be exactly matched against profile attributes.")
    integration_ids: Optional[List[StrictStr]] = Field(default=None, alias="integrationIDs")
    profile_ids: Optional[List[StrictInt]] = Field(default=None, alias="profileIDs")
