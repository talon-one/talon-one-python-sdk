...
class IntegrationGetAllCampaigns200Response(BaseModel):
    """
    IntegrationGetAllCampaigns200Response
    """ # noqa: E501
    has_more: StrictBool = Field(alias="hasMore")
    data: List[IntegrationCampaign]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [IntegrationCampaign.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
