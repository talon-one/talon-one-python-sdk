...
class CustomerAchievement(BaseModel):
    ...
    """ # noqa: E501
    id: StrictInt = Field(description="The internal ID of the achievement.", json_schema_extra={"examples": [3]})
    ...
    target: Union[StrictFloat, StrictInt] = Field(description="The required number of actions or the transactional milestone to complete the achievement.", json_schema_extra={"examples": [10]})
