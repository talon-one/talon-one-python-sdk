...
class Export(BaseModel):
    ...
    def entity_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Coupon', 'Referral', 'Effect', 'CustomerSession', 'LoyaltyLedger', 'LoyaltyLedgerLog', 'Collection']):
            raise ValueError("must be one of enum values ('Coupon', 'Referral', 'Effect', 'CustomerSession', 'LoyaltyLedger', 'LoyaltyLedgerLog', 'Collection')")
        return value
