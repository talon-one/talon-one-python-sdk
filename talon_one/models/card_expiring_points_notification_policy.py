...
class CardExpiringPointsNotificationPolicy(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="Notification name.", json_schema_extra={"examples": ["Notification to Google"]})
    triggers: Annotated[List[CardExpiringPointsNotificationTrigger], Field(min_length=1, max_length=3)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "triggers": [CardExpiringPointsNotificationTrigger.from_dict(_item) for _item in obj["triggers"]] if obj.get("triggers") is not None else None,
