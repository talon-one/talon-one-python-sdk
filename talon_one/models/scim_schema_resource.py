...
class ScimSchemaResource(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the resource.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the resource.")
    description: Optional[StrictStr] = Field(default=None, description="Human-readable description of the schema resource.")
