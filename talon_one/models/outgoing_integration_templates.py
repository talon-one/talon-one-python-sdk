...
class OutgoingIntegrationTemplates(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[OutgoingIntegrationTemplate]] = Field(default=None, description="The list of templates for a given outgoing integration type.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OutgoingIntegrationTemplate.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
