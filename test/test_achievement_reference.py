...
class TestAchievementReference(unittest.TestCase):
    """AchievementReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AchievementReference:
        """Test AchievementReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AchievementReference`
        """
    ...
    def testAchievementReference(self):
        """Test AchievementReference"""
