...
class TestRoleV2PermissionSet(unittest.TestCase):
    """RoleV2PermissionSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleV2PermissionSet:
        """Test RoleV2PermissionSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleV2PermissionSet`
        """
