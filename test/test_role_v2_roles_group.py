...
class TestRoleV2RolesGroup(unittest.TestCase):
    """RoleV2RolesGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleV2RolesGroup:
        """Test RoleV2RolesGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleV2RolesGroup`
        """
        model = RoleV2RolesGroup()
        if include_optional:
            return RoleV2RolesGroup(
