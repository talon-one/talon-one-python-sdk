...
class TestExtendedCoupon(unittest.TestCase):
    """ExtendedCoupon unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedCoupon:
        """Test ExtendedCoupon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedCoupon`
        """
        model = ExtendedCoupon()
        if include_optional:
            return ExtendedCoupon(
                id = 6,
