...
class TestIntegrationHubEventPayloadLoyaltyProfileBasedNotification(unittest.TestCase):
    """IntegrationHubEventPayloadLoyaltyProfileBasedNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationHubEventPayloadLoyaltyProfileBasedNotification:
        ...
        # uncomment below to create an instance of `IntegrationHubEventPayloadLoyaltyProfileBasedNotification`
        """
    ...
    def testIntegrationHubEventPayloadLoyaltyProfileBasedNotification(self):
        """Test IntegrationHubEventPayloadLoyaltyProfileBasedNotification"""
