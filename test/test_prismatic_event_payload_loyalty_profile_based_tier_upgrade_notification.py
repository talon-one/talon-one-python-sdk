...
class TestPrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification(unittest.TestCase):
    """PrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification:
        ...
        # uncomment below to create an instance of `PrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification`
        """
        model = PrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification()
        if include_optional:
            return PrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification(
    ...
    def testPrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification(self):
        """Test PrismaticEventPayloadLoyaltyProfileBasedTierUpgradeNotification"""
