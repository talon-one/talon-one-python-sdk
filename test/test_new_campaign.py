...
class TestNewCampaign(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> NewCampaign:
        """Test NewCampaign
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewCampaign`
        """
        model = NewCampaign()
        if include_optional:
            return NewCampaign(
