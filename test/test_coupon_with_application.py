...
class TestCouponWithApplication(unittest.TestCase):
    """CouponWithApplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CouponWithApplication:
        """Test CouponWithApplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CouponWithApplication`
        """
        model = CouponWithApplication()
        if include_optional:
            return CouponWithApplication(
                id = 6,
    ...
    def testCouponWithApplication(self):
        """Test CouponWithApplication"""
