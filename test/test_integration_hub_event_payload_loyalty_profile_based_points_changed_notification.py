...
class TestIntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification(unittest.TestCase):
    """IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification:
        ...
        # uncomment below to create an instance of `IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification`
        """
    ...
    def testIntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification(self):
        """Test IntegrationHubEventPayloadLoyaltyProfileBasedPointsChangedNotification"""
