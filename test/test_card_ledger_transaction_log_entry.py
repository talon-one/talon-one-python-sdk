...
class TestCardLedgerTransactionLogEntry(unittest.TestCase):
    """CardLedgerTransactionLogEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardLedgerTransactionLogEntry:
        """Test CardLedgerTransactionLogEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardLedgerTransactionLogEntry`
        """
    ...
    def testCardLedgerTransactionLogEntry(self):
        """Test CardLedgerTransactionLogEntry"""
