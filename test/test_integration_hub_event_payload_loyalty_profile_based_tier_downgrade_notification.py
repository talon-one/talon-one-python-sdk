...
class TestIntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification(unittest.TestCase):
    """IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification:
        """Test IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification`
        """
    ...
    def testIntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification(self):
        """Test IntegrationHubEventPayloadLoyaltyProfileBasedTierDowngradeNotification"""
