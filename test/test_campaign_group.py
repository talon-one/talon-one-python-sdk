...
class TestCampaignGroup(unittest.TestCase):
    """CampaignGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CampaignGroup:
        """Test CampaignGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CampaignGroup`
        """
        model = CampaignGroup()
        if include_optional:
