...
class TestNewReferral(unittest.TestCase):
    """NewReferral unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewReferral:
        """Test NewReferral
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewReferral`
        """
        model = NewReferral()
        if include_optional:
            return NewReferral(
