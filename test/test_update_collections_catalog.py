...
class TestUpdateCollectionsCatalog(unittest.TestCase):
    """UpdateCollectionsCatalog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCollectionsCatalog:
        """Test UpdateCollectionsCatalog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCollectionsCatalog`
        """
        model = UpdateCollectionsCatalog()
        if include_optional:
            return UpdateCollectionsCatalog(
                title = '',
                description = '',
                category = 'promotions',
                rules = [
    ...
    def testUpdateCollectionsCatalog(self):
        """Test UpdateCollectionsCatalog"""
