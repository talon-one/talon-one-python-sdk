...
class TestNewRuleset(unittest.TestCase):
    """NewRuleset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewRuleset:
        """Test NewRuleset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewRuleset`
        """
        model = NewRuleset()
        if include_optional:
            return NewRuleset(
