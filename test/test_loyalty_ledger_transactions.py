...
class TestLoyaltyLedgerTransactions(unittest.TestCase):
    """LoyaltyLedgerTransactions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoyaltyLedgerTransactions:
        """Test LoyaltyLedgerTransactions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoyaltyLedgerTransactions`
        """
        model = LoyaltyLedgerTransactions()
        if include_optional:
            return LoyaltyLedgerTransactions(
                has_more = True,
                data = [
    ...
    def testLoyaltyLedgerTransactions(self):
        """Test LoyaltyLedgerTransactions"""
