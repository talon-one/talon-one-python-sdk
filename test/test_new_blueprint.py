...
class TestNewBlueprint(unittest.TestCase):
    """NewBlueprint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewBlueprint:
        """Test NewBlueprint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewBlueprint`
        """
        model = NewBlueprint()
        if include_optional:
            return NewBlueprint(
