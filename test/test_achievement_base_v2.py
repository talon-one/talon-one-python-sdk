...
class TestAchievementBaseV2(unittest.TestCase):
    """AchievementBaseV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AchievementBaseV2:
        """Test AchievementBaseV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AchievementBaseV2`
        """
        model = AchievementBaseV2()
        if include_optional:
            return AchievementBaseV2(
    ...
    def testAchievementBaseV2(self):
        """Test AchievementBaseV2"""
