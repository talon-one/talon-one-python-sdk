...
class TestIntegrationHubEventRecord(unittest.TestCase):
    """IntegrationHubEventRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationHubEventRecord:
        """Test IntegrationHubEventRecord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationHubEventRecord`
        """
    ...
    def testIntegrationHubEventRecord(self):
        """Test IntegrationHubEventRecord"""
