...
class TestNewExperimentVariant(unittest.TestCase):
    """NewExperimentVariant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewExperimentVariant:
        """Test NewExperimentVariant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewExperimentVariant`
        """
    ...
    def testNewExperimentVariant(self):
        """Test NewExperimentVariant"""
