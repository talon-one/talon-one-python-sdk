...
class TestUpdateCoupon(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpdateCoupon:
        """Test UpdateCoupon
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCoupon`
        """
        model = UpdateCoupon()
        if include_optional:
            return UpdateCoupon(
