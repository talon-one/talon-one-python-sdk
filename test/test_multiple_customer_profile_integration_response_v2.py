...
class TestMultipleCustomerProfileIntegrationResponseV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MultipleCustomerProfileIntegrationResponseV2:
        """Test MultipleCustomerProfileIntegrationResponseV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MultipleCustomerProfileIntegrationResponseV2`
        """
