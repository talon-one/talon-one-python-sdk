...
class TestCustomerAchievement(unittest.TestCase):
    """CustomerAchievement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerAchievement:
        """Test CustomerAchievement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerAchievement`
        """
    ...
    def testCustomerAchievement(self):
        """Test CustomerAchievement"""
