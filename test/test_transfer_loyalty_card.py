...
class TestTransferLoyaltyCard(unittest.TestCase):
    """TransferLoyaltyCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferLoyaltyCard:
        """Test TransferLoyaltyCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferLoyaltyCard`
        """
    ...
    def testTransferLoyaltyCard(self):
        """Test TransferLoyaltyCard"""
