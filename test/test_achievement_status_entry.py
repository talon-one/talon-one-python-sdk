...
class TestAchievementStatusEntry(unittest.TestCase):
    """AchievementStatusEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AchievementStatusEntry:
        """Test AchievementStatusEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AchievementStatusEntry`
        """
        model = AchievementStatusEntry()
        if include_optional:
            return AchievementStatusEntry(
                id = 6,
    ...
    def testAchievementStatusEntry(self):
        """Test AchievementStatusEntry"""
