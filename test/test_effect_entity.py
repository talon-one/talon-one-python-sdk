...
class TestEffectEntity(unittest.TestCase):
    """EffectEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EffectEntity:
        """Test EffectEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EffectEntity`
        """
        model = EffectEntity()
        if include_optional:
            return EffectEntity(
