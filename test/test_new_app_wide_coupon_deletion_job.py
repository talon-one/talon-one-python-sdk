...
class TestNewAppWideCouponDeletionJob(unittest.TestCase):
    """NewAppWideCouponDeletionJob unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewAppWideCouponDeletionJob:
        """Test NewAppWideCouponDeletionJob
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewAppWideCouponDeletionJob`
        """
        model = NewAppWideCouponDeletionJob()
        if include_optional:
            return NewAppWideCouponDeletionJob(
    ...
    def testNewAppWideCouponDeletionJob(self):
        """Test NewAppWideCouponDeletionJob"""
