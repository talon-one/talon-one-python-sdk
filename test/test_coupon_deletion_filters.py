...
class TestCouponDeletionFilters(unittest.TestCase):
    """CouponDeletionFilters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CouponDeletionFilters:
        """Test CouponDeletionFilters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CouponDeletionFilters`
        """
        model = CouponDeletionFilters()
        if include_optional:
            return CouponDeletionFilters(
    ...
    def testCouponDeletionFilters(self):
        """Test CouponDeletionFilters"""
