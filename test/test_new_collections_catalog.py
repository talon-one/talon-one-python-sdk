...
class TestNewCollectionsCatalog(unittest.TestCase):
    """NewCollectionsCatalog unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewCollectionsCatalog:
        """Test NewCollectionsCatalog
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewCollectionsCatalog`
        """
        model = NewCollectionsCatalog()
        if include_optional:
            return NewCollectionsCatalog(
    ...
    def testNewCollectionsCatalog(self):
        """Test NewCollectionsCatalog"""
