...
class TestAchievementV2(unittest.TestCase):
    """AchievementV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AchievementV2:
        """Test AchievementV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AchievementV2`
        """
        model = AchievementV2()
        if include_optional:
