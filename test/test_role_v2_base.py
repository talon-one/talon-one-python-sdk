...
class TestRoleV2Base(unittest.TestCase):
    """RoleV2Base unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleV2Base:
        """Test RoleV2Base
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleV2Base`
        """
        model = RoleV2Base()
        if include_optional:
            return RoleV2Base(
