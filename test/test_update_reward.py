...
class TestUpdateReward(unittest.TestCase):
    """UpdateReward unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateReward:
        """Test UpdateReward
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateReward`
        """
        model = UpdateReward()
        if include_optional:
            return UpdateReward(
