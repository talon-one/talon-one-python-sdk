...
class TestOutgoingIntegrationTypes(unittest.TestCase):
    """OutgoingIntegrationTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutgoingIntegrationTypes:
        """Test OutgoingIntegrationTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutgoingIntegrationTypes`
        """
        model = OutgoingIntegrationTypes()
        if include_optional:
            return OutgoingIntegrationTypes(
                data = [
    ...
    def testOutgoingIntegrationTypes(self):
        """Test OutgoingIntegrationTypes"""
