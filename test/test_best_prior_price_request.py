...
class TestBestPriorPriceRequest(unittest.TestCase):
    """BestPriorPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BestPriorPriceRequest:
        """Test BestPriorPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BestPriorPriceRequest`
        """
    ...
    def testBestPriorPriceRequest(self):
        """Test BestPriorPriceRequest"""
