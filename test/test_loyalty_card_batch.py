...
class TestLoyaltyCardBatch(unittest.TestCase):
    """LoyaltyCardBatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoyaltyCardBatch:
        """Test LoyaltyCardBatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoyaltyCardBatch`
        """
