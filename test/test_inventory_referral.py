...
class TestInventoryReferral(unittest.TestCase):
    """InventoryReferral unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InventoryReferral:
        """Test InventoryReferral
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InventoryReferral`
        """
    ...
    def testInventoryReferral(self):
        """Test InventoryReferral"""
