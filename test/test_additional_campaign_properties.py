...
class TestAdditionalCampaignProperties(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdditionalCampaignProperties:
        """Test AdditionalCampaignProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdditionalCampaignProperties`
        """
        ...
        if include_optional:
            return AdditionalCampaignProperties(
                ...
                created_loyalty_points_count = 9,
                created_loyalty_points_effect_count = 2,
                redeemed_loyalty_points_count = 8,
